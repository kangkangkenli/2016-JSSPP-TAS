       ...
       for down=1:scale
           ...
           for up=down:scale
             UP = S(:,:,up,1);
              ...
              % here, the layer number of cube is calculated by (up-down+1)
              % and here should be (up-down +1)* max > vol_max, not >=.
              % because vol_max is initilized as 0
...
bin_left_size = bin_left_size(find(bin_left_size));
